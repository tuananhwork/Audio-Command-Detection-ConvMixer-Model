...
To the best of our knowledge, this work constitutes the first empirical study to adapt and validate ConvMixer for Mel-spectrogram-based audio classification, highlighting its potential as a lightweight and resource-efficient alternative to deeper CNN and Transformer architectures in practical audio tasks.
...
\textbf{ConvMixer-256/8 (ours)} & \textbf{0.7} & \textbf{0.3} & \textbf{97.4} & Vietnamese Speech Commands \\
\hline
\end{tabular}}
